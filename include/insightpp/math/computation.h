...
{
    T* __restrict out_ptr = out.data_ptr();
    const T* __restrict sample_batch_t_ptr = sample_batch_t.data_ptr();
    const T* __restrict weight_matrix_t_ptr = weight_matrix_t.data_ptr();
    const T* __restrict bias_ptr = bias.data_ptr();
